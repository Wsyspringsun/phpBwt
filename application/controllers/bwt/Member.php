...
class Member extends CI_Controller
{
    ...
    public function certification(){
       /*$requires = array("id"=>"缺少会员id","id_photo_positive"=>"缺少身份证正面照","id_photo_reverse"=>"缺少身份证反面照",
        ...
        $params['id_photo_reverse'] = 'http://bwt.glq.cc/upload/201901072108473379.jpg';
        $params['id_photo_unity'] = 'http://bwt.glq.cc/upload/201901072108473379.jpg';
        $params['alipay_qrcode'] = 'http://bwt.glq.cc/upload/201901072108473379.jpg';
		...
		if ($params['yzm'] == $this->session->tempdata('yzm')){
			...
			//在此验证支付宝号是否有效；拿到支付宝相关信息更改，先模拟  更改为验证是否重复
			$alipay_id_res= $this->member_model->getwhereRow(['alipay_id' => $params['alipay_id']],'id');//认证更新
