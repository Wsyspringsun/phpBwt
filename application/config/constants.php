...
defined('EXIT__AUTO_MAX')      OR define('EXIT__AU_MAX', 125); // highest automatically-assigned error code


define('IMAGEHOST','https://bangke001.oss-cn-beijing.aliyuncs.com/');       //图片主机前缀,这里是OBS服务器
define('BASE_URL','http://'.$_SERVER['HTTP_HOST'].'/');        //base_url
//define('BASE_URL','http://'.$_SERVER['HTTP_HOST'].'/bangke/');        //base_url
define('_PUBLIC',BASE_URL.'public/');           //public文件夹,放样式,图片等资源文件
...
define('HOMEMACHINE',5);       //矿机列表显示条数 g
