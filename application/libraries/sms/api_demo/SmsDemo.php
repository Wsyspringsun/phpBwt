...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIwItdPKtaGFo6"; // AccessKeyId

        $accessKeySecret = "mwWHkKrkoYr7QxdH1Txuan2eRWj1OD"; // AccessKeySecret
    ...
    public static function sendSms($phone,$tplId,$sign,$par) {  //$par为短信模板的参数,格式如下:['code'=>123,'name'=>'test'];
        ...
        $request->setTemplateParam(json_encode($par, JSON_UNESCAPED_UNICODE));
