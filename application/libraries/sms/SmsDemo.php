...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIh0zlfF5gdhYA"; // AccessKeyId

        $accessKeySecret = "cAHUG40ezn7qP6hrkqg6WXbvl34jt0"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($phone,$tplId,$sign,$yzm) {
